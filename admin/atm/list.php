             ...
             $no++;
                ?>                  
                    <tr>
                            ...
                            <td><?php echo $dt["nama_atm"];?></td>
                            <td><?php echo $dt["alamat"];?></td>
                            <td><?php echo $dt["informasi_lainnya"];?></td>
                            <td>
                            <a href="olah.php?mode=update&id_atm=<?php  echo $dt["id_atm"];?>" class="btn btn-info"><i class="fa fa-edit"></i> Ubah</a>
                            <a href="proses.php?mode=hapus&id_atm=<?php echo $dt["id_atm"];?>" class="btn btn-danger"onclick="return confirm('Hapus data?')"><i class="fa fa-trash"></i>Hapus</a>
                            </td>
                    </tr> 
                    <?php              
                }              
