             ...
             $no++;
                ?>                  
                    <tr>
                            ...
                            <td>
                            <a href="olah.php?mode=update&id_bank=<?php  echo $dt["id_bank"];?>" class="btn btn-info"><i class="fa fa-edit"></i> Ubah</a>
                            <a href="proses.php?mode=hapus&id_bank=<?php echo $dt["id_bank"];?>" class="btn btn-danger"onclick="return confirm('Hapus data?')"><i class="fa fa-trash"></i>Hapus</a>
                            </td>
                    </tr> 
                    <?php              
                }              
